/**
 * Teacher API Contracts - Adaimozhi Content Management
 *
 * Feature: 003-adaimozhi
 * Date: 2026-01-27
 *
 * These contracts define the API request/response shapes for teacher content management.
...
/**
 * Base adaimozhi entry schema (matches DB columns)
 */
...
// =============================================================================
// GET /api/teacher/practice/adaimozhi - List Entries
// =============================================================================
...
export const ListEntriesQuerySchema = z.object({
  ...
  search: z.string().optional(), // Search in phrase_text, missing_word
});
...
// =============================================================================
// POST /api/teacher/practice/adaimozhi - Create Entry
// =============================================================================
...
export const CreateEntryRequestSchema = z.object({
  phrase_text: z.string().min(1, 'Phrase text is required').refine(
    (val) => val.includes('_____'),
    'Phrase must contain blank marker (_____)'
  ),
...
// =============================================================================
// GET /api/teacher/practice/adaimozhi/[id] - Get Single Entry
// =============================================================================
...
// =============================================================================
// PATCH /api/teacher/practice/adaimozhi/[id] - Update Entry
// =============================================================================
...
export const UpdateEntryRequestSchema = z.object({
  phrase_text: z.string().min(1).refine(
    (val) => val.includes('_____'),
    'Phrase must contain blank marker (_____)'
  ).optional(),
...
// =============================================================================
// DELETE /api/teacher/practice/adaimozhi/[id] - Delete Entry
// =============================================================================
...
// =============================================================================
// POST /api/teacher/practice/adaimozhi/import - CSV Import
// =============================================================================
...
export const CSVRowSchema = z.object({
  phrase_with_blank: z.string().min(1).refine(
    (val) => val.includes('_____'),
    'Phrase must contain blank marker (_____)'
  ),
...
export const ConfirmImportRequestSchema = z.object({
  rows: z.array(z.number()), // Row numbers to import (from preview)
});
...
// =============================================================================
// POST /api/teacher/practice/adaimozhi/generate - AI Generation
// =============================================================================
...
export const AIGenerateRequestSchema = z.object({
  ...
  context: z.string().optional(), // Topic hint for generation
  phrase_text: z.string().optional(), // Required if type='distractors'
}).refine(
  (data) => data.type !== 'distractors' || data.phrase_text,
  { message: 'phrase_text required when generating distractors', path: ['phrase_text'] }
);
...
export const AIGenerateResponseSchema = z.object({
  ...
  cached: z.boolean(), // Whether result came from cache
});
...
export const TeacherErrorResponseSchema = z.object({
  error: z.object({
    code: TeacherErrorCodeSchema,
    message: z.string(),
    details: z.record(z.unknown()).optional(),
  }),
});
export type TeacherErrorResponse = z.infer<typeof TeacherErrorResponseSchema>;
